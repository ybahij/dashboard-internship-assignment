...
const AGENCIES_FILE_PATH = '../../../data/agencies_agency_rows.csv';
const EMPLOYEES_FILE_PATH = '../../../data/contacts_contact_rows.csv';
...
function readCsvData(filePath: string): Promise<CsvRow[]> {
  return new Promise<CsvRow[]>((resolve, reject) => {
    const results: CsvRow[] = [];
    fs.createReadStream(filePath)
      .pipe(csv())
      .on('data', (data: Record<string, string>) => results.push(data as CsvRow))
      .on('end', () => {
        resolve(results);
      })
